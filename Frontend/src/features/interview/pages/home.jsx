...
const Home = () => {
    ...
    if (loading) return <Loader fullscreen text="Loading your interview plan" subtext="Fetching your personalized data..." />
            ...
            <header className='page-header'>
                <div className='page-header__top'>
                    <div className='page-header__brand'>
                        <span className='page-header__logo'>AI</span>
                        <span className='page-header__brand-name'>InterviewAI</span>
                    </div>
                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='upload-section'>
                            ...
                            <label className='dropzone' htmlFor='resume'>
                                ...
                                {resumeFileName
                                    ? <p className='dropzone__selected'>📄 {resumeFileName}</p>
